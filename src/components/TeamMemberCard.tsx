...
const TeamMemberCard = ({ member, onArchive, close }) => {
  ...
  const handleArchive = () => {
    onArchive(member.id); // Call the archive function with the member's ID
  ...
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm relative">
      ...
      <div className="flex justify-center p-4">
        <img
          src={`https://homestyleserver.xcelsz.com/${member?.profile_image_url}`}
          alt={member?.name}

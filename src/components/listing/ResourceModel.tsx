          ...
          <Modal.Body>
            <Box sx={{ width: "100%", maxWidth: "900px" }}>
              ...
              {activeStep === steps.length ? (
                    ...
                    <Form>
                      <Form.Group className="mb-3 mt-3">
                        ...
                        >
                          ...
                          <option value="Resource Listings">Resource Listings</option>
                      ...
                      {listingType && (
                        <Form.Group className="mb-3">
                          ...
                          >
                            ...
                            <option value="Property News">Property Guide</option>
                  ...
                  <Form onSubmit={handleSubmit}>
                    {listingType === "Resource Listings" && (
                      <>
                            ...
                            <div className="columns-1 sm:columns-2 lg:columns-2 space-y-4 mt-3">
                              ...
                              <Form.Group className="mb-3">
                                ...
                                <Form.Control
                                  className="font-normal"
                                  type="number"
                                  name="total_minutes_read"
                                  placeholder="Enter Minutes to Read"
                                  value={formData.total_minutes_read}
                                  onChange={(e) =>
                                    handleInputChange(
                                      "total_minutes_read",
                                      e.target.value
                        ...
                        {activeStep === 4 && (
                          <div className="py-2 px-4 my-4 bg-white border-t font-poppins rounded-xl cursor-pointer  shadow-md max-w-[320px] lg:max-w-[350px] m-auto">
                            <div className="flex items-center mb-3 space-x-3">
                              <span className="bg-black mt-1 text-white text-sm px-2 py-[2px] rounded-xl h-7 flex items-center">
                              ...
                              <div className="">
                                <h2 className="text-lg font-semibold">
                                  {/* Property {isGuide ? "Guide" : "News"} */}
                                  {listingCate}
                                </h2>
                                {/* <p className="-mt-1 text-xs text-gray-600">{"info?.location"}</p> */}
                              </div>
                            </div>
                            <div
                                ...
                                backgroundImage: `url(${
                                  formData.displayImages?.[0]
                                    ? typeof formData.displayImages[0] ===
                                      ...
                                      : "fallback-image-url.jpg" // Use a fallback image
                                    : "fallback-image-url.jpg" // If displayImages is empty
                                })`,
                                backgroundSize: "cover",
                                backgroundPosition: "center",
                              }}
                ...
                {info?.shortDescription?.map((elem, index) => <li key={index}>{elem}</li>)}
            </ul> */}
                            </div>
